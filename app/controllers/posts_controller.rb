class PostsController < ApplicationController
    ...
    if @post.save
      ...
      redirect_to user_path(@post.user.username), notice: "Something went wrong creating post"
    end
  end
  ...
  def update
   if @post.update(post_params)
     ...
     redirect_to post_path(@post), notice: "Something went wrong updating post"
   end
  end
